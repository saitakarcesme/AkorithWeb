    ...
    <Page>
      ...
      <section className="border-y border-line bg-cream/40 px-6 py-24">
        <div className="relative mx-auto max-w-7xl">
          ...
          <Reveal delay={0.2} className="mx-auto mt-14 max-w-5xl">
            <DemoPanel view="companions" title="Companions — live demo, say hi to Athena" />
          </Reveal>
        </div>
      </section>
      ...
      <section className="px-6 py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mx-auto mt-14 grid max-w-6xl items-start gap-8 lg:grid-cols-[1fr_1.4fr]">
            <Reveal delay={0.1}>
              <AgentsMock />
            </Reveal>
            <Reveal delay={0.2}>
              <DemoPanel view="agents" title="Agents — live demo, pick one and preview" />
            </Reveal>
          </div>
          <Reveal delay={0.1}>
