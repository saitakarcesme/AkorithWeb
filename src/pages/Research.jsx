              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                {LIBRARY_BOOKS.map(([title, meta, gradient], index) => (
                  <motion.div key={title} whileHover={{ y: -6 }} className="min-w-0">
                    <div className={`aspect-[3/4] rounded-xl border border-white/10 bg-gradient-to-br ${gradient} p-4 shadow-[0_22px_40px_-24px_rgba(0,0,0,0.9)]`}>
                      ...
                      <p className="absolute" aria-hidden />
